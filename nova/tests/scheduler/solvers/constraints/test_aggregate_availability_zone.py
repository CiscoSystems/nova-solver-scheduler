...
from nova.scheduler.solvers.constraints import aggregate_availability_zone
from nova import test
from nova.tests.scheduler import solver_scheduler_fakes as fakes


class TestAggregateAvailabilityZoneConstraint(test.NoDBTestCase):

    def setUp(self):
        super(TestAggregateAvailabilityZoneConstraint, self).setUp()
        self.constraint_cls = aggregate_availability_zone.\
                                        AggregateAvailabilityZoneConstraint
